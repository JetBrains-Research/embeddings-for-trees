...
def generate_node_with_children(number_of_children: int, edges_to_root: bool = True) -> dgl.DGLGraph:
...
def generate_tree(height: int, branch_factor: int, edges_to_root: bool = True) -> dgl.DGLGraph:

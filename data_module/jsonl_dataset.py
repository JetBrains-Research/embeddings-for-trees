...
from utils.common import LABEL, AST, CHILDREN, TOKEN, NODE, SEPARATOR, TYPE
...
class JsonlTypedASTDataset(JsonlASTDataset):
    def __init__(self, data_file: str, vocabulary: TypedVocabulary, config: DictConfig):
        super().__init__(data_file, vocabulary, config)
